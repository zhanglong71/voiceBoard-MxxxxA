...
#ifndef __HK32F030xMxxA_USART_H
#define __HK32F030xMxxA_USART_H
...
/** @defgroup  USART_DirectionMode USART_DirectionMode
  * @{
  */ 
...
/** @defgroup USART_MuteMode_WakeUp_methods USART_MuteMode_WakeUp_methods
  * @{
  */
...
/** @defgroup USART_Address_Detection USART_Address_Detection
  * @{
  */ 
...
/** @defgroup USART_WakeUpSource  USART_WakeUpSource
  * @{
  */ 
...
/** @defgroup USART_DE_Polarity USART_DE_Polarity
  * @{
  */
...
/** @defgroup USART_Inversion_Pins USART_Inversion_Pins
  * @{
  */
...
/** @defgroup USART_AutoBaudRate_Mode USART_AutoBaudRate_Mode
  * @{
  */

#define USART_AutoBaudRate_StartBit          ((uint32_t)0x00000000)
#define USART_AutoBaudRate_FallingEdge       USART_CR2_ABRMOD_0
...
/** @defgroup USART_OVR_DETECTION USART_OVR_DETECTION
  * @{
  */
...
/**
  * @}
  */ 
/** @defgroup USART_Request USART_Request
  * @{
  */
...
#define IS_USART_CLEAR_FLAG(FLAG) (((FLAG) == USART_FLAG_WU) || ((FLAG) == USART_FLAG_TC) || \
                                   ...
                                   ((FLAG) == USART_FLAG_NE) || ((FLAG) == USART_FLAG_FE) || \
                                   ((FLAG) == USART_FLAG_LBDF) || ((FLAG) == USART_FLAG_PE) || \
...
#define IS_USART_CONFIG_IT(IT) (((IT) == USART_IT_PE) || ((IT) == USART_IT_TXE) || \
                                ...
                                ((IT) == USART_IT_ERR) || ((IT) == USART_IT_RTO) || \
                                ((IT) == USART_IT_EOB) || ((IT) == USART_IT_CM) ||\
                                ((IT) == USART_IT_WU))
...
#define IS_USART_GET_IT(IT) (((IT) == USART_IT_PE) || ((IT) == USART_IT_TXE) || \
                             ...
                             ((IT) == USART_IT_FE) || ((IT) == USART_IT_RTO) || \
                             ((IT) == USART_IT_EOB) || ((IT) == USART_IT_CM) || \
                             ((IT) == USART_IT_WU))
...
#define IS_USART_CLEAR_IT(IT) (((IT) == USART_IT_TC) || ((IT) == USART_IT_PE) || \
                               ...
                               ((IT) == USART_IT_LBD) || ((IT) == USART_IT_RTO) || \
                               ((IT) == USART_IT_EOB) || ((IT) == USART_IT_CM) || \
                               ((IT) == USART_IT_WU))
/**
  * @}
...
/** @defgroup IS_USART_DE_ASSERTION_DEASSERTION_TIME IS_USART_DE_ASSERTION_DEASSERTION_TIME
  * @{
  */
