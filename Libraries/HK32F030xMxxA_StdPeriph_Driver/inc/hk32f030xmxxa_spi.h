...
* @Filename: hk32f030xmxxa_spi.h
* @Brief  : This file provides firmware functions for initialization 
             and configuration functions.
* @Author : AE Team  
********************************************************************/

/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef __HK32F030XMXXA_SPI_H
#define __HK32F030XMXXA_SPI_H
