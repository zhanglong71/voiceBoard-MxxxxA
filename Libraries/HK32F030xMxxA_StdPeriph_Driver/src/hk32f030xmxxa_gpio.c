...
/**
  ...
  * @param  eIOMUX_Pinx: where x can be 1,2,4,5,6,7,8,9,11,12,13,15 to select the GPIO pin.
...
void GPIO_IOMUX_ChangePin(IOMUX_PIN eIOMUX_Pinx, uint32_t IOMUX_FuncPin)
{
  ...
  switch (eIOMUX_Pinx)
  {
    case IOMUX_PIN1:   /* for SOP8,TSSOP16, QFN20, QFN 24 ,QFN 28 */
#if defined (HK32F030xMJxM7A) /* SOP8 */
      IOMUX->PKG_PIN_SEL &= IOMUX_PD6_SEL_MASK;//clear select bits(7 8)
      IOMUX->PKG_PIN_SEL |= IOMUX_FuncPin;
#elif defined (HK32F030xMDxP7A) /* TSSOP16 */
...
#elif defined (HK32F030xMFxU7A) || defined (HK32F030xMExU7A) || defined (HK32F030xMGxU7A) /* QFN20, QFN24, QFN28  */
    ...
    case IOMUX_PIN2:  /* TSSOP16, TSSOP20, TSSOP24 ,TSSOP28 */
#if defined (HK32F030xMDxP7A) /* TSSOP16 */
      if((IOMUX_FuncPin == IOMUX_PD6_SEL_PD6) || (IOMUX_FuncPin == IOMUX_PD6_SEL_PD4))
      {
        IOMUX->PKG_PIN_SEL &= IOMUX_PD6_SEL_MASK;//clear select bits(7 8)
        IOMUX->PKG_PIN_SEL |= IOMUX_FuncPin;
...
#elif  defined (HK32F030xMFxP7A) || defined (HK32F030xMExP7A) || defined (HK32F030xMGxP7A) /* TSSOP20, TSSOP24, TSSOP28 */
    ...
    case IOMUX_PIN4: /* TSSOP20, TSSOP24, TSSOP28 */
#if defined (HK32F030xMFxP7A) || defined (HK32F030xMExP7A) || defined (HK32F030xMGxP7A)
      if((IOMUX_FuncPin == IOMUX_NRST_SEL_PA0) || (IOMUX_FuncPin == IOMUX_NRST_SEL_NRST))
      {
        IOMUX->NRST_PIN_KEY = NRST_PINKEY;
        IOMUX->PKG_PIN_SEL &= IOMUX_NRST_SEL_MASK;//clear select bits(0)
    ...
    case IOMUX_PIN5: /* SOP8 */
#if defined (HK32F030xMJxM7A)
      IOMUX->PKG_PIN_SEL &= IOMUX_PB5_SEL_MASK;//clear select bits(2 1)
      IOMUX->PKG_PIN_SEL |= IOMUX_FuncPin;
#endif
      break;

    case IOMUX_PIN6: /* SOP8 */
#if defined (HK32F030xMJxM7A)
    ...
    case IOMUX_PIN8:  /* SOP8, QFN20 */
#if defined (HK32F030xMJxM7A)  /* SOP8 */
      IOMUX->PKG_PIN_SEL &= IOMUX_PD5_SEL_MASK;//clear select bits (6 5)
      IOMUX->PKG_PIN_SEL |= IOMUX_FuncPin;
#elif defined (HK32F030xMFxU7A)  /* QFN20 */
      IOMUX->PKG_PIN_SEL &= IOMUX_PB5_SEL_MASK;//clear select bits (2 1 )
      IOMUX->PKG_PIN_SEL |= IOMUX_FuncPin;
#endif
      break;

    case IOMUX_PIN9:  /* TSSOP16, QFN24, QFN28 */
#if defined (HK32F030xMDxP7A) || defined (HK32F030xMExU7A) || defined (HK32F030xMGxU7A)
    ...
    case IOMUX_PIN11: /* TSSOP20 */
#if defined (HK32F030xMFxP7A)
      IOMUX->PKG_PIN_SEL &= IOMUX_PB5_SEL_MASK;//clear select bits (2 1 )
      IOMUX->PKG_PIN_SEL |= IOMUX_FuncPin;
#endif
      break;

    case IOMUX_PIN12: /* TSSOP16, TSSOP24*/
#if defined (HK32F030xMDxP7A)  /* TSSSOP16 */
...
#elif defined (HK32F030xMExP7A)  /* TSSOP24 */
    ...
    case IOMUX_PIN13: /* TSSOP28 */
#if defined (HK32F030xMGxP7A)
      if((IOMUX_FuncPin == IOMUX_PB5_SEL_PB5) || (IOMUX_FuncPin == IOMUX_PB5_SEL_PD2))
      {
        IOMUX->PKG_PIN_SEL &= IOMUX_PB5_SEL_MASK;//clear select bits (2 1 )
        IOMUX->PKG_PIN_SEL |= IOMUX_FuncPin;
    ...
    case IOMUX_PIN15: /* TSSOP16 */
#if defined (HK32F030xMDxP7A)
    ...
    case IOMUX_PIN19:  /* QFN20 */
#if defined (HK32F030xMFxU7A)
      if(IOMUX_FuncPin == IOMUX_PD5_SEL_PD5)
      {
        IOMUX->PKG_PIN_SEL &= IOMUX_PD5_SEL_MASK;//clear select bits (6 5)
        IOMUX->PKG_PIN_SEL |= IOMUX_FuncPin;
    ...
    case IOMUX_PIN23: /* QFN24 */
#if defined (HK32F030xMExU7A)
      if(IOMUX_FuncPin == IOMUX_PD5_SEL_PD5)
      {
        IOMUX->PKG_PIN_SEL &= IOMUX_PD5_SEL_MASK;//clear select bits (6 5)
        IOMUX->PKG_PIN_SEL |= IOMUX_FuncPin;
    ...
    case IOMUX_PIN27: /* QFN28 */
#if defined (HK32F030xMGxU7A)
      if(IOMUX_FuncPin == IOMUX_PD5_SEL_PD5)
      {
        IOMUX->PKG_PIN_SEL &= IOMUX_PD5_SEL_MASK;//clear select bits (6 5)
        IOMUX->PKG_PIN_SEL |= IOMUX_FuncPin;
...
void GPIO_IOMUX_SetTIM2CN1_Source(TIM2_SOURCE TIM2CN1Source)
{
  ...
  IOMUX->TIM2_CH0_IN_SEL = (uint32_t)TIM2CN1Source;
}
